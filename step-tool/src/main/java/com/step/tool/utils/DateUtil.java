...
public class DateUtil {
    ...
    public static final String PATTERN_DATE_FIRST_MM = "MM/dd/yyyy";
    ...
    public static final ConcurrentDateFormat DATETIME_FORMAT2 = ConcurrentDateFormat.of(PATTERN_DATETIME2);
